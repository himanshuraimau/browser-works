  ...
  return (
    <div className="flex items-center justify-center py-8">
      <svg width="500" height="300" viewBox="0 0 500 300" className="max-w-full">
        ...
        <rect x="175" y="20" width="150" height="60" rx="6" fill="#ea580c" stroke="#ea580c" strokeWidth="2" className="pulse-box"/>
        ...
        {/* Connection lines */}
        <line x1="250" y1="80" x2="70" y2="140" stroke="#ea580c" strokeWidth="2" opacity="0.3" strokeDasharray="5,5"/>
        <line x1="250" y1="80" x2="210" y2="140" stroke="#ea580c" strokeWidth="2" opacity="0.3" strokeDasharray="5,5"/>
        <line x1="250" y1="80" x2="350" y2="140" stroke="#ea580c" strokeWidth="2" opacity="0.3" strokeDasharray="5,5"/>
        <line x1="250" y1="80" x2="430" y2="140" stroke="#ea580c" strokeWidth="2" opacity="0.3" strokeDasharray="5,5"/>
