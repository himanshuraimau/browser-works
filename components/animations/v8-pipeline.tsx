  ...
  return (
    <div className="flex items-center justify-center py-8">
      <svg width="500" height="200" viewBox="0 0 500 200" className="max-w-full">
        ...
        {/* Arrow */}
        <line x1="90" y1="60" x2="120" y2="60" stroke="var(--brand-accent)" strokeWidth="2" className="flow-arrow"/>
        <polygon points="130,60 120,55 120,65" fill="var(--brand-accent)"/>
        ...
        {/* Arrow */}
        <line x1="210" y1="60" x2="240" y2="60" stroke="var(--brand-accent)" strokeWidth="2" className="flow-arrow" style={{ animationDelay: '0.3s' }}/>
        <polygon points="250,60 240,55 240,65" fill="var(--brand-accent)"/>
        ...
        {/* Arrow */}
        <line x1="330" y1="60" x2="360" y2="60" stroke="var(--brand-accent)" strokeWidth="2" className="flow-arrow" style={{ animationDelay: '0.9s' }}/>
        <polygon points="370,60 360,55 360,65" fill="var(--brand-accent)"/>
        ...
        <line x1="410" y1="90" x2="410" y2="120" stroke="var(--brand-accent)" strokeWidth="2" className="flow-arrow"/>
        <polygon points="410,130 405,120 415,120" fill="var(--brand-accent)"/>
