  ...
  return (
    <div className="flex items-center justify-center py-8">
      <svg width="380" height="140" viewBox="0 0 380 140" className="max-w-full">
        ...
        {/* SSD (Solid) */}
        <rect x="20" y="30" width="90" height="60" rx="4" fill="var(--brand-accent)" opacity="0.15" stroke="var(--brand-accent)" strokeWidth="2"/>
        ...
        {/* Data flow arrow */}
        <path d="M 115 60 L 155 60" stroke="var(--brand-accent)" strokeWidth="2" fill="none" markerEnd="url(#arrowhead)"/>
        <defs>
        ...
        <g className="hdd-spin">
          <circle cx="80" cy="60" r="30" fill="none" stroke="var(--brand-accent)" strokeWidth="1" opacity="0.3"/>
          <circle cx="80" cy="60" r="20" fill="none" stroke="var(--brand-accent)" strokeWidth="1.5" opacity="0.5"/>
          <circle cx="80" cy="60" r="10" fill="none" stroke="var(--brand-accent)" strokeWidth="1" opacity="0.7"/>
        </g>
        ...
        {/* Writing indicator */}
        <path d="M 240 40 L 280 80 M 280 40 L 240 80" stroke="var(--brand-accent)" strokeWidth="2.5" className="write-animation"/>
        <rect x="220" y="35" width="100" height="60" rx="4" fill="none" stroke="var(--brand-accent)" strokeWidth="1" opacity="0.3"/>
